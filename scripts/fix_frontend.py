...
def call_check(text, backend_choice):
    ...
    # Defensive key access — handles both v0.2.0 and v0.3.0 schemas
    ...
    if spelling_errors:
        for err in spelling_errors:
            ...
            lines.append(f"🔴 **{word}** (स्थान: {offset}) → सुचवण्या: {sugg}")
    else:
    ...
    if grammar_errors:
        for err in grammar_errors:
            ...
            lines.append(f"🟡 {message}{detail} *(type: {rule_type})*")
    else:
